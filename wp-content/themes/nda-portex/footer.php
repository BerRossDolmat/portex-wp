...
<div class="contact-us-btn">
    <a class="btn-floating btn-large waves-effect waves-light blue lighten-2 tooltipped modal-trigger" data-position="left" data-delay="50" data-tooltip="Напишите нам" href="#send-letter-modal">
        <i class="material-icons">email</i>
    </a>
</div>

<!-- Send Letter Modal -->
<div id="send-letter-modal" class="modal modal-fixed-footer">
    ...
    <div class="modal-content">
        <form class="row" onsubmit="sendLetter();return false;">
            <div class="input-field col s12 m12">
                <input id="name-bottom" type="text" class="validate" required oninvalid="this.setCustomValidity('Представьтесь пожалуйста')" oninput="setCustomValidity('')">
                <label for="name-bottom">Представьтесь пожалуйста</label>
            </div>
            <div class="input-field col s12 m12">
                <input id="email-bottom" type="email" class="validate" required oninvalid="this.setCustomValidity('Введите Ваш email')" oninput="setCustomValidity('')">
                <label for="email-bottom">Ваш Email</label>
            </div>
            <div class="input-field col s12 m12">
                <textarea id="message-bottom" class="materialize-textarea" required oninvalid="this.setCustomValidity('Введите текст сообщения')" oninput="setCustomValidity('')"></textarea>
...
<div id="contactsModal" class="modal modal-fixed-footer">
    <div class="close-symbol"><a href="#" class="modal-action modal-close">&#10006;</a></div>
    <div class="modal-content">
        <h4>Контакты</h4>
        <div class="row">
            <div class="col s12">
                <p>Компания «НДА Деловая Медицинская Компания» с 1992 года является Вашим партнером и поставщиком оборудования и расходных материалов для хирургии, анестезиологии и реанимации.<br><br> Нашими клиентами являются городские больницы, родильные
                    дома, научно-исследовательские и учебные институты и академии, государственные поликлиники и частные лечебные учреждения Санкт-Петербурга, Москвы, Новгорода, Пскова, Мурманска, Вологды, Череповца, Костромы, Твери, Сыктывкара, Ставрополя,
                    Тамбова, Екатеринбурга, Новосибирска, Южно- Сахалинска, Краснодара и других городов. Среди наших клиентов множество медицинских фирм, география которых охватывает всю Россию.</p>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="col m12 l4">
                ...
                <form class="row" onsubmit="contactUs();return false;">
                    <div class="input-field col s12">
                        <input id="name" type="text" class="validate" required oninvalid="this.setCustomValidity('Представьтесь пожалуйста')" oninput="setCustomValidity('')">
                        <label for="name">Представьтесь пожалуйста</label>
                    </div>
                    <div class="input-field col s12">
                        <input id="email" type="email" class="validate" required oninvalid="this.setCustomValidity('Введите Ваш email')" oninput="setCustomValidity('')">
                        <label for="email">Ваш Email</label>
                    </div>
                    <div class="input-field col s12">
                        <textarea id="message" class="materialize-textarea" required oninvalid="this.setCustomValidity('Введите текст сообщения')" oninput="setCustomValidity('')"></textarea>
